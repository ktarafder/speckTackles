...
{
vec2 l9_67;
Node176_Switch(0.0,vec2(0.0),vec2(0.0),vec2(0.0),vec2(0.0),vec2(0.0),l9_67,l9_8);
l9_66=varColor.xyz*vec3(sc_SampleTextureBiasOrLevel(materialParamsTexDims.xy,materialParamsTexLayout,materialParamsTexGetStereoViewIndex(),l9_67,(int(SC_USE_UV_TRANSFORM_materialParamsTex)!=0),materialParamsTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex),(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0),materialParamsTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0),materialParamsTexBorderColor,0.0,materialParamsTex).z);
}
#else
{
vec2 l9_68;
Node176_Switch(0.0,vec2(0.0),vec2(0.0),vec2(0.0),vec2(0.0),vec2(0.0),l9_68,l9_8);
l9_66=vec3(sc_SampleTextureBiasOrLevel(materialParamsTexDims.xy,materialParamsTexLayout,materialParamsTexGetStereoViewIndex(),l9_68,(int(SC_USE_UV_TRANSFORM_materialParamsTex)!=0),materialParamsTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex),(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0),materialParamsTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0),materialParamsTexBorderColor,0.0,materialParamsTex).z);
}
#endif
vec3 l9_69;
...
#endif
float l9_70=clamp(l9_23,0.0,1.0);
...
#endif
vec3 l9_71=max(l9_9.xyz,vec3(0.0));
vec4 l9_72;
#if (sc_ProjectiveShadowsCaster)
{
l9_72=vec4(l9_71,l9_70);
}
#else
{
vec3 l9_73=clamp(l9_66,vec3(0.0),vec3(1.0));
vec3 l9_74=ssSRGB_to_Linear(l9_71);
vec3 l9_75=normalize(l9_69);
vec3 l9_76=ssSRGB_to_Linear(max(l9_65,vec3(0.0)));
vec3 l9_77;
#if (sc_SSAOEnabled)
{
l9_77=evaluateSSAO(varPos);
}
#else
{
l9_77=l9_73;
...
#endif
vec3 l9_78=l9_74*(1.0-0.0);
SurfaceProperties l9_79=SurfaceProperties(l9_78,l9_70,l9_75,varPos,l9_7,0.0,1.0,l9_76,l9_77,vec3(1.0),vec3(1.0),vec3(0.039999999));
vec4 l9_80=vec4(1.0);
vec3 l9_81;
vec3 l9_82;
vec3 l9_83;
...
l9_89=vec3(0.0);
l9_88=vec3(0.0);
LightingComponents l9_95;
LightProperties l9_96;
SurfaceProperties l9_97;
vec3 l9_98;
int l9_99=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_99<sc_DirectionalLightsCount)
{
LightingComponents l9_100=accumulateLight(LightingComponents(l9_88,l9_89,l9_94,l9_92,l9_91,l9_90),LightProperties(sc_DirectionalLights[l9_99].direction,sc_DirectionalLights[l9_99].color.xyz,sc_DirectionalLights[l9_99].color.w*l9_80[(l9_93<3) ? l9_93 : 3]),l9_79,l9_7);
l9_94=l9_100.indirectDiffuse;
l9_93++;
l9_92=l9_100.indirectSpecular;
l9_91=l9_100.emitted;
l9_90=l9_100.transmitted;
l9_89=l9_100.directSpecular;
l9_88=l9_100.directDiffuse;
l9_99++;
continue;
}
else
...
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_117<sc_PointLightsCount)
{
vec3 l9_119=sc_PointLights[l9_117].position-varPos;
vec3 l9_120=normalize(l9_119);
float l9_121=l9_80[(l9_118<3) ? l9_118 : 3];
float l9_122=clamp((dot(l9_120,sc_PointLights[l9_117].direction)*sc_PointLights[l9_117].angleScale)+sc_PointLights[l9_117].angleOffset,0.0,1.0);
float l9_123=(sc_PointLights[l9_117].color.w*l9_121)*(l9_122*l9_122);
float l9_124;
if (sc_PointLights[l9_117].falloffEnabled)
{
l9_124=l9_123*computeDistanceAttenuation(length(l9_119),sc_PointLights[l9_117].falloffEndDistance);
}
else
{
l9_124=l9_123;
...
l9_110=l9_118+1;
LightingComponents l9_125=accumulateLight(LightingComponents(l9_104,l9_105,l9_109,l9_108,l9_107,l9_106),LightProperties(l9_120,sc_PointLights[l9_117].color.xyz,l9_124),l9_79,l9_7);
l9_111=l9_125.directDiffuse;
l9_112=l9_125.directSpecular;
l9_113=l9_125.indirectDiffuse;
l9_114=l9_125.indirectSpecular;
l9_115=l9_125.emitted;
l9_116=l9_125.transmitted;
l9_109=l9_113;
l9_118=l9_110;
l9_108=l9_114;
l9_107=l9_115;
...
#if (sc_ProjectiveShadowsReceiver)
{
vec2 l9_128=abs(varShadowTex-vec2(0.5));
vec4 l9_129=texture2D(sc_ShadowTexture,varShadowTex)*step(max(l9_128.x,l9_128.y),0.5);
l9_127=mix(vec3(1.0),mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_129.xyz,vec3(sc_ShadowColor.w)),vec3(l9_129.w*sc_ShadowDensity));
}
#else
{
l9_127=vec3(1.0);
...
{
float l9_131=-l9_75.z;
float l9_132=l9_75.x;
vec2 l9_133=vec2((((l9_132<0.0) ? (-1.0) : 1.0)*acos(clamp(l9_131/length(vec2(l9_132,l9_131)),-1.0,1.0)))-1.5707964,acos(l9_75.y))/vec2(6.2831855,3.1415927);
float l9_134=l9_133.x+(sc_EnvmapRotation.y/360.0);
vec2 l9_135=vec2(l9_134,1.0-l9_133.y);
l9_135.x=fract((l9_134+floor(l9_134))+1.0);
vec4 l9_136;
...
#endif
l9_138=sc_SampleView(sc_EnvmapDiffuseDims.xy,l9_139,sc_EnvmapDiffuseLayout,l9_140,-13.0,sc_EnvmapDiffuse);
}
#else
{
...
#endif
l9_130=(l9_136.xyz*(1.0/l9_136.w))*sc_EnvmapExposure;
}
#else
{
vec3 l9_141;
...
{
l9_147=l9_130+(sc_AmbientLights[0].color*sc_AmbientLights[0].intensity);
}
#else
{
vec3 l9_148=l9_130;
l9_148.x=l9_130.x+(1e-06*sc_AmbientLights[0].color.x);
l9_147=l9_148;
}
#endif
l9_146=l9_147;
...
{
float l9_159=dot(sc_LightEstimationData.sg[l9_158].axis,l9_75);
...
l9_172=vec3(0.0);
l9_171=vec3(0.0);
l9_170=ssSRGB_to_Linear(sc_GetFramebufferColor().xyz)*mix(vec3(1.0),l9_78,vec3(l9_70));
l9_169=1.0;
}
#else
{
...
#endif
vec3 l9_174=l9_171*l9_77;
vec3 l9_175=l9_172+l9_174;
vec3 l9_176=l9_78*l9_175;
vec3 l9_177=l9_103*vec3(1.0);
vec3 l9_178;
if (l9_173)
{
l9_178=l9_176*srgbToLinear(l9_169);
}
else
{
l9_178=l9_176;
}
vec3 l9_179=l9_178+(vec3(0.0)+l9_177);
vec3 l9_180=(l9_179+l9_76)+l9_170;
float l9_181=l9_180.x;
vec4 l9_182=vec4(l9_181,l9_180.yz,l9_169);
vec4 l9_183;
#if (sc_IsEditor)
{
vec4 l9_184=l9_182;
l9_184.x=l9_181+((l9_77.x*1.0)*9.9999997e-06);
l9_183=l9_184;
}
#else
{
...
l9_72=vec4(l9_188.x,l9_188.y,l9_188.z,l9_185.w);
}
#endif
vec4 l9_189=max(l9_72,vec4(0.0));
vec4 l9_190;
#if (sc_ProjectiveShadowsCaster)
{
float l9_191;
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_192=clamp(l9_189.w*2.0,0.0,1.0);
}
#else
{
float l9_193;
...
{
l9_193=clamp(dot(l9_189.xyz,vec3(l9_189.w)),0.0,1.0);
}
#else
{
float l9_194;
...
#if (sc_BlendMode_Multiply)
{
l9_195=(1.0-dot(l9_189.xyz,vec3(0.33333001)))*l9_189.w;
}
#else
{
float l9_196;
...
{
l9_196=(1.0-clamp(dot(l9_189.xyz,vec3(1.0)),0.0,1.0))*l9_189.w;
}
#else
{
float l9_197;
#if (sc_BlendMode_ColoredGlass)
{
l9_197=clamp(dot(l9_189.xyz,vec3(1.0)),0.0,1.0)*l9_189.w;
}
#else
{
float l9_198;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_199=clamp(dot(l9_189.xyz,vec3(1.0)),0.0,1.0)*l9_189.w;
}
#else
{
float l9_200;
...
{
l9_200=dot(l9_189.xyz,vec3(0.33333001))*l9_189.w;
}
#else
{
float l9_201;
...
{
vec3 l9_205=sc_GetFramebufferColor().xyz;
vec3 l9_206=mix(l9_205,definedBlend(l9_205,l9_189.xyz).xyz,vec3(l9_189.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
float l9_209=l9_189.w;
l9_208=vec4(mix(vec3(1.0),l9_189.xyz,vec3(l9_209)),l9_209);
}
#else
{
vec4 l9_210;
...
{
float l9_211=l9_189.w;
float l9_212;
#if (sc_BlendMode_PremultipliedAlphaAuto)
{
l9_212=clamp(l9_211,0.0,1.0);
}
#else
{
l9_212=l9_211;
...
#endif
l9_210=vec4(l9_189.xyz*l9_212,l9_212);
}
#else
{
l9_210=l9_189;
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_220=sc_ScreenCoordsGlobalToView(l9_3);
...
#if (sc_OITCompositingPass)
{
vec2 l9_233=sc_ScreenCoordsGlobalToView(l9_3);
#if (sc_OITMaxLayers4Plus1)
{
